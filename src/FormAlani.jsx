    ...
    return (<form onSubmit={handleSubmit}>
        <div className="boyutHamur">
            <div>
                ...
                <div className="boyut">
                    <label ><input onChange={handleChange} type="radio" id="'kücük" name="boyut" value='kücük' checked={form.boyut=='kücük'?true:false} />
                        Küçük</label>
            ...
            <div className="ekmalzemeler">
                <div >
                    <div className="birinci" >
                        <label><input onChange={handleChange} checked={form.pepperoni} type="checkbox" name="pepperoni" id="pepperoni" />
                            Pepperoni</label>
                        <label> <input onChange={handleChange} checked={form.sosis}  type="checkbox" name="sosis" id="sosis" />
                            Sosis</label>
                        <label><input onChange={handleChange} checked={form.jambon} type="checkbox" name="jambon" id="jambon" />
                            Kanada Jambonu</label>
                        <label><input onChange={handleChange} checked={form.izgara} type="checkbox" name="izgara" id="izgara" />
                            Tavuk Izgara</label>
                ...
                <div>
                    <div className="birinci" >
                        <label><input onChange={handleChange} checked={form.domates} type="checkbox" name="domates" id="domates" />
                            Domates</label>
                        <label> <input onChange={handleChange} checked={form.misir} type="checkbox" name="misir" id="misir" />
                            Mısır</label>
        ...
        <div className="alttaraf" style={{ marginTop: '5rem' }}>
            ...
            <div className="siparis">
                ...
                <button type="submit" disabled={!isValid} style={{ marginTop: '0px', borderRadius: '0px' }} className="siparisver">Sipariş ver</button>
            </div>
        </div>
    </form>)
}